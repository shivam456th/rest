...
import { ArrowRight, ArrowUpRight, Instagram, Facebook, Twitter, MapPin, Quote, 
  Star, Users, Leaf, Armchair, BadgePercent,Flame, Utensils,
  ShoppingBag, X, Plus, CreditCard, Banknote, Smartphone, CheckCircle, ZoomIn, Phone, MessageCircle, Clock, Car, Accessibility, Mail   } from "lucide-react";
...
const Hero = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      {/* 1. Background Image/Video with Overlay */}
      <div className="absolute inset-0 z-0">
        {/* Maine yahan ek high-quality Dhaba/Dining image use ki hai. Aap isse apni video se replace kar sakte hain */}
        <img
      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-[#EAE6DF]">
        ...
        >
          Step into a world where rustic charm meets culinary excellence. 
          Enjoy authentic flavors in a warm, cinematic atmosphere right in the heart of the city.
        </motion.p>
...
const BrandStory = () => {
  return (
    <section className="relative py-24 px-4 md:px-12 bg-[#EAE6DF] overflow-hidden">
      ...
      {/* Background Texture / Motif (Subtle Pattern) */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10 max-w-7xl mx-auto">
        ...
        {/* Left Side: Visual Storytelling (Collage) */}
        <div className="relative">
          {/* Main Large Image (Atmosphere) */}
          <motion.div
          ...
          {/* Floating Accent Image (Food Close-up) */}
          <motion.div
        ...
        <div className="lg:pl-8">
          ...
          >
            <p>
              What started as a humble clay-oven stop on the winding <strong>Mussoorie Road</strong> has evolved into a landmark of culinary heritage. For over two decades, Mukhiya’s Dhaba has been a comforting pause for weary travelers and a celebration destination for families.
            </p>
            <p>
              We believe in the philosophy of <em>"Atithi Devo Bhava"</em>. Our recipes haven't changed—we still hand-grind our spices and slow-cook our dals over charcoal—but we've elevated the experience to match the modern diner's desire for comfort and hygiene.
            </p>
          </motion.div>
          ...
          <div className="mt-10">
            <a href="#about" className="group inline-flex items-center gap-2 text-[#2A231D] font-bold uppercase tracking-widest text-sm hover:text-[#8C3E32] transition-colors">
  ...
  return (
    <section className="py-12 border-y border-[#D1CDC5]/30 bg-white/50 backdrop-blur-sm relative z-20">
      <div className="container mx-auto px-4">
        {/* Mobile: Horizontal Scroll, Desktop: Center Grid */}
...
const DigitalMenu = () => {
  const [openCategory, setOpenCategory] = useState("Tandoor Specials"); // Default open
  ...
  const menuData = [
    {
      ...
      count: 12,
      items: [
        { name: "Dahi Ke Kebab", price: "₹345", desc: "Hung curd patties spiced with cardamom and pan-fried.", spice: 1, tag: "Bestseller", img: "https://images.unsplash.com/photo-1601050690597-df0568f70950?q=80&w=800&auto=format&fit=crop" },
        { name: "Amritsari Fish Fry", price: "₹525", desc: "Batter-fried fresh river sole with carom seeds.", spice: 2, tag: "Chef's Rec", img: "https://images.unsplash.com/photo-1626132647523-66f5bf380027?q=80&w=800&auto=format&fit=crop" }
      ]
    },
    {
      ...
      count: 8,
      items: [
        { name: "Murgh Malai Tikka", price: "₹495", desc: "Chicken marinated in cream cheese, cashew paste and grilled.", spice: 1, tag: "Kids Favorite", img: "https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?q=80&w=800&auto=format&fit=crop" },
        { name: "Seekh Kebab Gilafi", price: "₹545", desc: "Minced mutton skewers coated with colored bell peppers.", spice: 3, tag: "Spicy", img: "https://images.unsplash.com/photo-1565557623262-b51c2513a641?q=80&w=800&auto=format&fit=crop" },
        { name: "Paneer Tikka Shashlik", price: "₹395", desc: "Cottage cheese cubes grilled with onion and capsicum.", spice: 2, tag: "Veg Delight", img: "https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?q=80&w=800&auto=format&fit=crop" }
      ]
    },
    {
      ...
      count: 24,
      items: [
        { name: "Mukhiya's Dal Makhani", price: "₹375", desc: "Black lentils slow-cooked overnight on charcoal.", spice: 1, tag: "Signature", img: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?q=80&w=800&auto=format&fit=crop" },
        { name: "Butter Chicken 1998", price: "₹575", desc: "Classic shredded chicken in rich tomato gravy.", spice: 2, tag: "Legendary", img: "https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?q=80&w=800&auto=format&fit=crop" }
      ]
    },
    {
      category: "Thalis",
      count: 5,
      items: [
        { name: "Royal Punjabi Thali", price: "₹650", desc: "A platter of 3 curries, naan, rice, raita and sweet.", spice: 2, tag: "Value Meal", img: "https://images.unsplash.com/photo-1626776420079-95e247494630?q=80&w=800&auto=format&fit=crop" }
      ]
    },
          ...
          {menuData.map((category) => (
            <div key={category.category} className="border-b border-[#D1CDC5]">
              ...
              <button 
                ...
                className={`w-full flex items-center justify-between py-8 px-4 transition-all duration-300 hover:bg-white/40 ${openCategory === category.category ? 'bg-white/60' : ''}`}
              >
                <div className="flex items-center gap-6 md:gap-12">
                  <span className="text-sm font-bold text-[#2A231D]/40 w-8 text-left">
                    ({category.count})
                  </span>
                  <h3 className={`text-2xl md:text-4xl font-medium uppercase transition-colors ${openCategory === category.category ? 'text-[#8C3E32]' : 'text-[#2A231D]'}`}>
                    {category.category}
                  </h3>
                </div>
                ...
                {openCategory === category.category && (
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-4 md:p-8 bg-white/30">
                      ...
                      {category.items.length > 0 ? category.items.map((dish, idx) => (
                        <div key={idx} className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 border border-[#D1CDC5]/20">
                          {/* Dish Image */}
                          <div className="h-48 overflow-hidden relative">
                            <img src={dish.img} alt={dish.name} className="w-full h-full object-cover transform group-hover:scale-110 transition-duration-700" />
                            {dish.tag && (
                          ...
                          <div className="p-5">
                            <div className="flex justify-between items-start mb-2">
                              ...
                              <span className="font-serif font-bold text-[#2A231D]">{dish.price}</span>
                            </div>
                            <p className="text-sm text-[#2A231D]/70 mb-4 line-clamp-2">
                              {dish.desc}
                            </p>
                            
                            {/* Footer: Spice & Add Button */}
                            <div className="flex justify-between items-center border-t border-[#D1CDC5]/30 pt-4">
                              <div className="flex gap-1" title={`Spice Level: ${dish.spice}/3`}>
                                {[...Array(3)].map((_, i) => (
                                  <Flame 
                                    key={i} 
                                    size={14} 
                                    className={i < dish.spice ? "fill-[#8C3E32] text-[#8C3E32]" : "text-[#D1CDC5]"} 
                                  />
                                ))}
                              </div>
                              <button className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-[#2A231D] hover:text-[#8C3E32] transition-colors">
                                Add <div className="w-5 h-5 rounded-full border border-current flex items-center justify-center">+</div>
                              </button>
                            </div>
                          </div>
                        </div>
                      )) : (
                        <p className="col-span-3 text-center py-10 opacity-50 italic">Full menu coming soon...</p>
                      )}
  ...
  const galleryImages = [
    {
      ...
      span: "md:col-span-2 md:row-span-2", // Badi photo
    },
    {
      id: 2,
      ...
      <div className="container mx-auto px-4 md:px-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <p className="text-[#2A231D]/70 max-w-sm text-right md:text-left">
            From sizzling tandoors to laughter-filled tables, glimpse the soul of our dhaba before you visit.
          </p>
        </div>
      ...
      <div className="container mx-auto px-4 md:px-12 relative z-10">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          >
             ...
             <span className="text-xs font-bold uppercase tracking-widest opacity-80">Trusted by 50,000+ Foodies</span>
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          {/* 1. Influencer / Blogger Spotlight (Left Side - Big Card) */}
          <motion.div 
            initial={{ opacity: 0, x: -50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
             <div className="relative z-10">
                ...
                <p className="text-xl md:text-2xl font-serif italic leading-relaxed mb-6">
                  "I've traveled all over North India, but the Dal Makhani at Mukhiya's hits different. It's not just food; it's a warm hug on a plate. Highly recommended for anyone visiting Mussoorie."
                </p>
                <div className="flex items-center gap-4 border-t border-[#2A231D]/10 pt-6">
                   <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#8C3E32]">
                      <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=200&auto=format&fit=crop" alt="Blogger" className="w-full h-full object-cover" />
                   </div>
                   <div>
                      <h4 className="font-bold uppercase text-sm">Sanya Eats</h4>
                      <p className="text-xs opacity-60 uppercase tracking-widest">Food Blogger • 120k Followers</p>
                   </div>
                   <Instagram className="ml-auto w-6 h-6 text-[#8C3E32]" />
                </div>
             </div>
             {/* Abstract Blob for decoration */}
             <div className="absolute -bottom-20 -right-20 w-64 h-64 bg-[#8C3E32] opacity-10 rounded-full blur-3xl" />
          </motion.div>

          {/* 2. Customer Reviews Grid (Right Side) */}
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 content-center">
             {reviews.map((review, idx) => (
               ...
               >
                 <div className="flex justify-between items-start mb-4">
                    ...
                    <img 
                      src={review.source === "Google Review" ? "https://cdn-icons-png.flaticon.com/512/300/300221.png" : "https://cdn-icons-png.flaticon.com/512/2504/2504845.png"} 
                      alt={review.source}
                 ...
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       <h5 className="font-bold text-xs uppercase tracking-wide">{review.name}</h5>
             ...
             >
                ...
                <h4 className="font-bold uppercase text-lg mb-1">Share your story</h4>
                <p className="text-xs opacity-80 mb-0">Rate us on Google & get 5% off next time.</p>
             </motion.div>
          </div>
...
const FooterSection = () => {
  return (
    <footer id="contact" className="bg-[#2A231D] text-[#EAE6DF] relative z-10">
      ...
      {/* Top Section: Split Layout (Info + Map) */}
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="p-8 md:p-16 flex flex-col justify-between h-full">
           <div>
              ...
              <div className="space-y-8 max-w-md">
                 ...
                 <div className="flex gap-4 items-start">
                    ...
                    <div>
                       <h4 className="font-bold uppercase text-sm mb-1">Mukhiya's Dhaba</h4>
                       <p className="opacity-70 leading-relaxed">
                         12th Milestone, Mussoorie Road,<br/>
                 ...
                 <div className="flex gap-4 items-start">
                    ...
                    <div>
                       ...
                       <p className="opacity-50 text-xs mt-1">Kitchen closes at 10:30 PM</p>
                    </div>
                 </div>

                 {/* Contact Actions (One-Tap) */}
                 <div className="flex gap-4 items-start pt-4">
                    <a href="tel:+919876543210" className="flex-1 bg-[#EAE6DF] text-[#2A231D] py-3 px-4 rounded-lg flex items-center justify-center gap-2 font-bold uppercase text-xs hover:bg-[#fff] transition-colors">
                       <Phone size={16} /> Call Us
                    </a>
                    <a href="https://wa.me/919876543210" className="flex-1 bg-[#25D366] text-white py-3 px-4 rounded-lg flex items-center justify-center gap-2 font-bold uppercase text-xs hover:bg-[#20bd5a] transition-colors">
           ...
           <div className="mt-16 pt-8 border-t border-[#EAE6DF]/10 flex flex-wrap gap-6 text-xs font-bold uppercase tracking-widest opacity-60">
              <span className="flex items-center gap-2"><Car size={16}/> Valet Parking</span>
              <span className="flex items-center gap-2"><Accessibility size={16}/> Wheelchair Accessible</span>
              <span className="flex items-center gap-2"><Leaf size={16}/> Pet Friendly</span>
           </div>
        </div>
